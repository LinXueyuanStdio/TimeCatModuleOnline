 ...
 * @usage null
 */
@RouterAnno(hostAndPath = RouterHub.USER_LifeActivityEditorActivity)
class LifeActivityEditorActivity : BaseActivityAddActivity() {

    @AttrValueAutowiredAnno("block")
    @JvmField
    var task: Block? = null
    override fun title(): String = "成长活动"
