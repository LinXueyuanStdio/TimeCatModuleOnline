 ...
 * @usage null
 */
@ServiceAnno(CreateBlockTypeService::class, name = [RouterHub.CREATE_CreateService_BLOCK_DIALOG])
class CREATE_CreateService_BLOCK_DIALOG : CreateBlockTypeService {
