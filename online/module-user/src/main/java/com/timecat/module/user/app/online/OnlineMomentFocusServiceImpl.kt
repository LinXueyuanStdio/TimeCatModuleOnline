...
import com.timecat.module.user.ext.GLOBAL_OnlineMomentFocusService
 ...
 * @usage 根据关注列表
 */
@ServiceAnno(ContainerService::class, name = [GLOBAL_OnlineMomentFocusService])
class OnlineMomentFocusServiceImpl : ContainerService {
