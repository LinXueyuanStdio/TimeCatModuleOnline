...
import com.timecat.identity.data.block.type.ACTIVITY_Card
 ...
 * @usage null
 */
@RouterAnno(hostAndPath = RouterHub.USER_CardActivityEditorActivity)
class CardActivityEditorActivity : BaseActivityAddActivity() {
    ...
    override fun subtype(): Int = ACTIVITY_Card
