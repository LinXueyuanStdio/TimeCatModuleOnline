...
import com.timecat.module.user.ext.GLOBAL_OnlineGameService
 ...
 * 目前数据量比较少，先根据更新时间排序
 */
@ServiceAnno(ContainerService::class, name = [GLOBAL_OnlineGameService])
class OnlineGameServiceImpl : ContainerService {
