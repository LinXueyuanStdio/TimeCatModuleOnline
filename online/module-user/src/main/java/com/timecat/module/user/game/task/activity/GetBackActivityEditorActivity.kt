 ...
 * @usage null
 */
@RouterAnno(hostAndPath = RouterHub.USER_GetBackActivityEditorActivity)
class GetBackActivityEditorActivity : BaseActivityAddActivity() {

    @AttrValueAutowiredAnno("block")
    @JvmField
    var task: Block? = null
    override fun title(): String = "回归活动"
