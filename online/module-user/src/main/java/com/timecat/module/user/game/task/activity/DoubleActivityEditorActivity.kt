...
import com.timecat.identity.data.block.type.ACTIVITY_Double
 ...
 * @usage null
 */
@RouterAnno(hostAndPath = RouterHub.USER_DoubleActivityEditorActivity)
class DoubleActivityEditorActivity : BaseActivityAddActivity() {
    ...
    override fun subtype(): Int = ACTIVITY_Double
