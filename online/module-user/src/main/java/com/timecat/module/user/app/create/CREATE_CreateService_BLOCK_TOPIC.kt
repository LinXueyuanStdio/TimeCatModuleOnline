 ...
 * @usage null
 */
@ServiceAnno(CreateBlockTypeService::class, name = [RouterHub.CREATE_CreateService_BLOCK_TOPIC])
class CREATE_CreateService_BLOCK_TOPIC : CreateBlockTypeService {
    override fun type(): Int = BLOCK_TOPIC
    override fun typeItem(parent: RoomRecord?): TypeItem = TypeItem(BLOCK_TOPIC, "话题符文 -> ${parent?.title ?: "根目录"}", "话题符文", true)
