 ...
 * @usage null
 */
@ServiceAnno(CreateBlockTypeService::class, name = [RouterHub.CREATE_CreateService_BLOCK_SPACE])
class CREATE_CreateService_BLOCK_SPACE : CreateBlockTypeService {
    override fun type(): Int = BLOCK_SPACE
    override fun typeItem(parent: RoomRecord?): TypeItem = TypeItem(BLOCK_SPACE, "空间符文 -> ${parent?.title ?: "根目录"}", "空间符文", true)
