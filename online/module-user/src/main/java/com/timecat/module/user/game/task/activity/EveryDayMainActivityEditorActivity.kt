 ...
 * @usage null
 */
@RouterAnno(hostAndPath = RouterHub.USER_EveryDayMainActivityEditorActivity)
class EveryDayMainActivityEditorActivity : BaseActivityAddActivity() {

    @AttrValueAutowiredAnno("block")
    @JvmField
    var task: Block? = null
    override fun title(): String = "每日活动"
