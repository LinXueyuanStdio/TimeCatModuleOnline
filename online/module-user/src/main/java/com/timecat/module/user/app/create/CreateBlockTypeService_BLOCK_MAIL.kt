...
class CreateBlockTypeService_BLOCK_MAIL : CreateBlockTypeService {
    ...
    override fun typeItem(parent: RoomRecord?): TypeItem = TypeItem(BLOCK_MAIL, "Markdown", "Markdown 符文。", true)
    override suspend fun buildFactory(): CreateBlockSubTypeService = CreateSubTypeService_BLOCK_MAIL()
}

class CreateSubTypeService_BLOCK_MAIL : CreateBlockSubTypeService {
