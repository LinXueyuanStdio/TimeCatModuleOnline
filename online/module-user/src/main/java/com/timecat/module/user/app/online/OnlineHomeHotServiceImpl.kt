 ...
 * @usage 根据热度排序
 */
@ServiceAnno(ContainerService::class, name = [GLOBAL_OnlineHomeHotService])
class OnlineHomeHotServiceImpl : ContainerService {
    ...
    var dataloader: UserHomeHot? = null
    ...
    override fun loadForVirtualPath(
        ...
        if (I == null) {
            ...
            dataloader = UserHomeHot(I, pageSize)
