package com.timecat.module.theme;
...
public class ThemeActivity extends BaseRefreshListActivity  {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (itemId == R.id.current) {
            new ThemeInfoBottomSheetDialog().showIfNeed(getSupportFragmentManager());
            return true;
        } else if (itemId == R.id.myTheme) {
            startActivity(new Intent(this, DesignMyThemeActivity.class));
            return true;
        }
